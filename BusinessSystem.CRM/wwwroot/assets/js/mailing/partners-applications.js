...
$(document).ready(function() {
    ...
    */
    $("#btn-reply").on('click', function(event) {
        ...
        let $html2 = '<div id="'+randomAlphaNumeric+'" class="collapse" aria-labelledby="sdfsdaf" data-parent="#mailbox-inbox">'+
            '<div class="mail-content-container sentmail" data-mailFrom="'+$_mailFrom+'" data-mailTo="'+$_mailTo+'" data-mailCC="'+$_mailCC+'" >'+
    ...
    */
    function $_GET_mailItem_Draft() {
        $(".mail-item.draft").off('click').on('click', function(event) {
            ...
            let $_mailFrom =  $(this).find('.f-body').attr('data-mailFrom');
            let $_mailTo =  $(this).find('.f-body').attr('data-mailTo');
            let $_mailCC =  $(this).find('.f-body').attr('data-mailCC');
            let $_mailSubject =  $(this).find('.mail-title').attr('data-mailtitle');
            let $_mailDataTarget =  $(this).find('.mail-item-heading').attr('data-target');
            $_sendMail($_mailDataTarget);
            let $_mailDescription =  JSON.parse($(this).find('.mail-content-excerpt').attr('data-maildescription'));
    ...
    */
    function $_GET_mailItem_Reply() {
        $(".reply").on('click', function(event) {
            ...
            let $_mailFrom =  $(this).parents('.mail-content-container').attr('data-mailFrom');
            let $_mailTo =  $(this).parents('.mail-content-container').attr('data-mailTo');
            let $_mailCC =  $(this).parents('.mail-content-container').attr('data-mailCC');
            let $_mailSubject = $(this).parents('.mail-content-container').find('.mail-content').attr('data-mailtitle');
            let $_mailDescription =  JSON.parse($(this).parents('.mail-content-container').find('.mail-content').attr('data-maildescription'));
